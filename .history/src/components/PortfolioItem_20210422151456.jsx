...
const PortfolioItem = ({
  ...
  return (
    <>
      <Col md={2} sm={6} className="portfolio-item">
        <a
          role="button"
          tabIndex={-1}
        ...
        >
          ...
          /> */}
          <iframe width="560" height="315" src={imageFileName} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen/> 
